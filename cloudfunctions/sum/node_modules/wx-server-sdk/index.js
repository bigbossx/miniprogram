...
function callWXSvrkit(options) {
    ...
    return new Promise(function (resolve, reject) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        var pbInstance, result, parsedResult, returnValue, e_1, error;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!options) {
                    ...
                    pbInstance = options.pbInstance;
                    if (pbInstance) {
                        options = tslib_1.__assign({}, options, pbInstance.data);
                ...
                case 2:
                    result = _a.sent();
                    console.log('callSvrkit callOpenAPI result: ', result);
                    parsedResult = result.result;
                    try {
                        if (typeof parsedResult === 'string') {
                            // let parsedResult: {
                    ...
                    try {
                        if (parsedResult.ret === 0) {
                            ...
                            if (pbInstance && options.existResp) {
                                parsedResult.respBody = pbInstance.decode(parsedResult.respBodyBuffer).toJSON();
                            }
                        }
                    }
                    catch (e) {
                        // no nothing
                        console.log('error while parsing buffer', e);
                    }
                    returnValue = {
